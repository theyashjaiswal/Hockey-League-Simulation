...
public class RosterStatusTest {
    ...
    public void setStatusInactiveTest()
    {
        ...
        assertEquals(league.getConferences().get(0).getDivisions().get(0).getTeams().get(0).getPlayers().get(0).getIsActive(),false);
    }
    ...
    public void setStatusActiveTest()
    {
        ...
        assertEquals(league.getConferences().get(0).getDivisions().get(0).getTeams().get(0).getPlayers().get(0).getIsActive(),true);
    }
}